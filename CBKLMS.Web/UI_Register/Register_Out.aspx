<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Register_Out.aspx.cs" Inherits="UI_Register_Register_Out" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <script>
        var ServiceUrl = "/WebService/UI_Register/Register_OUT_Service.asmx/";
        ...
        function InitControls() {
            ...
            $('#hidintertek_user_id').val('<%= CkUserId %>');
            $('#txtintertek_user_nm').val('<%= CkUserNm %>' + " (" + '<%= CkUserEnm %>' + ")");
        ...
        function SaveRegisterFirst() {
            ...
            $.ajax({
                url: ServiceUrl + "SaveRegisterFirst",
                type: "POST",
                contentType: "application/json; charset=utf-8",
                data: JSON.stringify({
